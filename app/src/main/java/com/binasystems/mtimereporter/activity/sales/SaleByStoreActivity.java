...
public class SaleByStoreActivity extends BaseActivity implements View.OnClickListener{
	TextView cancel;

	public static void startAcitivty(Context caller, Date date, ComaxApiManager.DateViewType dateViewType){
		Intent intent = new Intent(caller, SaleByStoreActivity.class);
		if(date != null){
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(savedInstanceState == null){
			Fragment fragment = new SalesByStoreFragment();
